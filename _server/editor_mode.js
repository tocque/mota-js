editor_mode = function (editor) {
    ...
    var editor_mode = new Vue({
        ...
        methods: {
            ...
            doActionList: function (mode, actionList, callback) {
            ...
            checkFloorIds: function (thiseval) {
            ...
            changeDoubleClickModeByButton: function (mode) {
                ({
                    delete: function () {
            ...
            editModeSelect_onchange: function () {
